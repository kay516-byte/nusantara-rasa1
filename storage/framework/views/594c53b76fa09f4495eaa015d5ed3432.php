...
<body class="bg-gray-50">
    ...
    <nav class="bg-white border-b sticky top-0 z-10">
        <div class="max-w-6xl mx-auto px-8 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Nusantara Rasa" class="h-8 w-auto">
            ...
            <div class="hidden md:flex items-center gap-8 text-sm text-gray-600 font-medium">
                ...
                <a href="<?php echo e(route('resep.index')); ?>" class="hover:text-orange-500">
                    Resep
                </a>
    ...
    <div id="beranda" class="max-w-6xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('resep.create')); ?>"
        ...
        <div class="relative">
            ...
            <?php if($heroReseps->count() > 0): ?>

                <img src="<?php echo e(asset('storage/' . $heroReseps[0]->foto)); ?>"
                     class="w-full h-80 object-cover rounded-3xl shadow-lg">

                <?php if($heroReseps->count() > 1): ?>

                    <img src="<?php echo e(asset('storage/' . $heroReseps[1]->foto)); ?>"
                    ...
                    <a href="<?php echo e(route('resep.index', ['kategori_id' => $kategori->id])); ?>"
                       class="bg-orange-50 hover:bg-orange-100 rounded-2xl p-6 text-center transition">
                        ...
                        <p class="text-gray-400 text-xs mt-1">
                            <?php echo e($kategori->reseps()->count()); ?> resep
                        </p>
    ...
    <footer id="kontak" class="bg-gray-900 text-gray-300">
        ...
        <div class="border-t border-gray-800 py-4 text-center text-xs text-gray-500">
            © <?php echo e(date('Y')); ?> Nusantara Rasa. Tugas Kuliah — Dibuat dengan Laravel.
        </div>

    </footer>

</body>
</html><?php /**PATH C:\Users\ASUS\OneDrive\apa aja\laraveltugas\nusantara-rasa\resources\views/welcome.blade.php ENDPATH**/ ?>