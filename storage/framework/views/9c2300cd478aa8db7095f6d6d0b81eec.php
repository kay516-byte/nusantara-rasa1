...
<body class="bg-orange-50 min-h-screen flex items-center justify-center px-4">
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <form action="<?php echo e(url('/register')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Sudah punya akun?
                <a href="<?php echo e(route('login')); ?>" class="text-orange-600 font-semibold hover:underline">Masuk</a>
            </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\ASUS\OneDrive\apa aja\laraveltugas\nusantara-rasa\resources\views/auth/register.blade.php ENDPATH**/ ?>