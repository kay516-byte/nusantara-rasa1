    ...
    <div class="bg-white border-b">
        <div class="max-w-6xl mx-auto px-6 pt-6 pb-10">
            ...
            <div class="flex items-center gap-6 mb-8">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Nusantara Rasa" class="h-10 w-auto">

                <form action="<?php echo e(route('resep.index')); ?>" method="GET" class="flex-1 max-w-md">
                    <div class="flex items-center bg-gray-100 rounded-full px-4 py-2.5">
                        <span class="text-gray-400 mr-2">🔍</span>
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari Resep"
                ...
                <div class="flex items-center gap-4 ml-auto">
                    ...
                    <form action="<?php echo e(route('logout')); ?>" method="POST">s
                        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 px-6 py-5 flex items-center justify-between flex-wrap gap-3 mb-6">
            <div class="flex gap-2 flex-wrap">
                <a href="<?php echo e(route('resep.index')); ?>"
                   class="px-4 py-2 rounded-full text-sm font-medium <?php echo e(!request('kategori_id') ? 'bg-gray-800 text-white' : 'text-gray-500 hover:bg-gray-50'); ?>">
                    Semua
                </a>
                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('resep.index', ['kategori_id' => $kategori->id])); ?>"
                       class="px-4 py-2 rounded-full text-sm font-medium <?php echo e(request('kategori_id') == $kategori->id ? 'bg-gray-800 text-white' : 'text-gray-500 hover:bg-gray-50'); ?>">
                        <?php echo e($kategori->nama_kategori); ?>

                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <a href="<?php echo e(route('resep.create')); ?>" class="bg-orange-500 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-orange-600 whitespace-nowrap">
                + Tambah Resep
            </a>
        </div>

        <p class="text-gray-500 text-sm mb-4">Anda memiliki <span class="font-semibold text-gray-700"><?php echo e($reseps->count()); ?></span> resep untuk dicoba.</p>

        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div class="lg:col-span-3">
                <?php if($reseps->isEmpty()): ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                        <?php $__currentLoopData = $reseps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                                <div class="relative">
                                    <a href="<?php echo e(route('resep.show', $resep->id)); ?>">
                                        <?php if($resep->foto): ?>
                                            <img src="<?php echo e(asset('storage/' . $resep->foto)); ?>" class="w-full h-36 object-cover">
                                        <?php else: ?>
                                            <div class="w-full h-36 bg-gray-100 flex items-center justify-center text-3xl text-gray-300">🍽️</div>
                                        <?php endif; ?>
                                    </a>
                                    <button type="button"
                                            onclick="toggleLike(this, <?php echo e($resep->id); ?>)"
                                ...
                                <div class="p-3">
                                    <h3 class="font-semibold text-gray-800 text-sm mb-1 leading-snug">
                                        <a href="<?php echo e(route('resep.show', $resep->id)); ?>" class="hover:text-orange-600"><?php echo e($resep->nama_resep); ?></a>
                                    </h3>
                                    <p class="text-xs text-gray-400 mb-2">
                                        <span class="text-gray-600 font-medium"><?php echo e($resep->kategori->nama_kategori ?? '-'); ?></span>
                                    </p>
                                    <div class="flex items-center justify-between text-xs text-gray-400 border-t pt-2">
                                        <span>💬 <?php echo e((($resep->id * 7) % 30) + 3); ?></span>
                                        <span>❤️ <?php echo e((($resep->id * 13) % 40) + 5); ?></span>
                                        <div class="flex gap-2">
                                            <a href="<?php echo e(route('resep.edit', $resep->id)); ?>" class="text-blue-600 hover:underline">Edit</a>
                                            <form action="<?php echo e(route('resep.destroy', $resep->id)); ?>" method="POST" onsubmit="return confirm('Yakin hapus?')">
                                                <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2 text-sm">
                                <div class="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center text-orange-500 text-xs font-bold">
                                    <?php echo e(substr($kategori->nama_kategori, 0, 1)); ?>

                                </div>
                                <div>
                                    <p class="text-gray-700 font-medium"><?php echo e($kategori->nama_kategori); ?></p>
                                    <p class="text-gray-400 text-xs"><?php echo e($kategori->reseps()->count()); ?> resep</p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
</html><?php /**PATH C:\Users\ASUS\OneDrive\apa aja\laraveltugas\nusantara-rasa\resources\views/resep/index.blade.php ENDPATH**/ ?>